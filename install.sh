...
#echo 'IAM_AUTHORIZED_GROUPS="GROUPNAMES"' >> /etc/aws-ec2-ssh.conf
...
#echo 'SUDOERSGROUP="GROUPNAME"' >> /etc/aws-ec2-ssh.conf
...
#echo 'LOCAL_GROUPS="GROUPNAMES"' >> /etc/aws-ec2-ssh.conf
...
#echo 'ASSUMEROLE="ASSUMEROLEARN"' >> /etc/aws-ec2-ssh.conf
