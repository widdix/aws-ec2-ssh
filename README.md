...
3. Install the RPM *: `rpm -i https://s3-eu-west-1.amazonaws.com/widdix-aws-ec2-ssh-releases-eu-west-1/aws-ec2-ssh-1.5.0-1.el7.centos.noarch.rpm`
...
> * Check the [releases](https://github.com/widdix/aws-ec2-ssh/releases) and use the latest released RPM.
